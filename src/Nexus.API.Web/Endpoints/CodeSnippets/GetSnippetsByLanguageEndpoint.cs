...
/// <summary>
/// Get snippets by language endpoint
/// GET /api/v1/snippets/by-language/{language}
/// </summary>
public class GetSnippetsByLanguageEndpoint : Endpoint<GetSnippetsByLanguageRequest, CodeSnippetPagedResultDto>
{
  private readonly ICodeSnippetRepository _snippetRepository;
  private readonly UserManager<ApplicationUser> _userManager;

  public GetSnippetsByLanguageEndpoint(
  ...
  {
    Get("/snippets/by-language/{language}");
    Roles("Viewer", "Editor", "Admin");

    Description(b => b
      .WithTags("Code Snippets")
      .WithSummary("Get snippets by language")
      .WithDescription("Retrieves snippets filtered by programming language. Only returns public snippets or user's own snippets."));
  }

  public override async Task HandleAsync(
    GetSnippetsByLanguageRequest request,
    CancellationToken ct)
  {
    ...
    var allSnippets = await _snippetRepository.GetByLanguageAsync(request.Language, ct);
...
public record GetSnippetsByLanguageRequest(string Language);
