...
/// <summary>
/// Endpoint: DELETE /api/v1/diagrams/{diagramId}
/// Deletes a diagram (soft delete)
/// Requires: Editor, Admin roles
/// </summary>
public class DeleteDiagramEndpoint : EndpointWithoutRequest
{
  private readonly IDiagramRepository _diagramRepository;

  public DeleteDiagramEndpoint(IDiagramRepository diagramRepository)
  {
  ...
  public override void Configure()
  {
    ...
    Description(b => b
      .WithTags("Diagrams")
      .WithSummary("Delete diagram")
      .WithDescription("Soft deletes a diagram."));
  }
